...
type Source struct {
	// Type defines the kind of Source content being sourced.
	Type SourceType `json:"type"`
	// Image is the image that backs the content of this Source.
	...
	// directory paths that represent a source filesystem.
	ConfigMaps []ConfigMapSource `json:"configMaps,omitempty"`
	// Upload is a source that enables this Source's content to be uploaded
