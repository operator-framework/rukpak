...
manifests: controller-gen ## Generate manifests e.g. CRD, RBAC etc
	...
	$(CONTROLLER_GEN) crd:crdVersions=v1alpha1 output:crd:dir=./manifests paths=./pkg/api/v1alpha1/...

	@# Update existing CRDs from type changes
	$(CONTROLLER_GEN) schemapatch:manifests=./manifests output:dir=./manifests paths=./pkg/api/v1alpha1/...
