...
func (p list) Probe(obj *unstructured.Unstructured) (bool, string) {
	var messages []string
	for _, probe := range p {
...
func (cp *conditionProbe) Probe(obj *unstructured.Unstructured) (bool, string) {
	success, message := func() (bool, string) {
...
func (fe *fieldsEqualProbe) Probe(obj *unstructured.Unstructured) (bool, string) {
...
func (cg *statusObservedGenerationProbe) Probe(obj *unstructured.Unstructured) (bool, string) {
	if observedGeneration, ok, err := unstructured.NestedInt64(
